...
export const GridPlusIconOutline = () => (
  <svg
    className="w-6 h-6"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const GridPlusIconSolid = () => (
  <svg
    className="w-6 h-6 text-green"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const PlusIcon = ({ green }: { green?: boolean }) => (
  <svg
    className={`w-6 h-6 ${green ? "text-green" : ""}`}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
export const CheckIcon = () => (
  <svg
    className="w-5 h-5 p-0.5 absolute top-0.5 left-0 z-10 invisible peer-checked:visible text-black bg-green border-green rounded"
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
interface StarIconSolidProps {
  size?: string;
}

export const StarIconSolid: React.FC<StarIconSolidProps> = ({
  size = "w-6 h-6",
}) => (
  <svg
    className={`${size} text-green`}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    viewBox="0 0 24 24"
...
export const MusicIcon = () => (
  <svg role="img" viewBox="0 0 24 24" className="w-20 h-20 fill-silver-900">
